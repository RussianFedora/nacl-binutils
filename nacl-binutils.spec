...
# cd nacl-binutils
# git checkout 38c9b31a526f8ba3028e2172316c55b6f0108b2a
# cd ..
# For binutils version, grep "AM_INIT_AUTOMAKE(bfd, " bfd/configure.in
# mv nacl-binutils nacl-binutils-2.20.1-git38c9b31a
# tar cfj nacl-binutils-2.20.1-git38c9b31a.tar.bz2 nacl-binutils-2.20.1-git38c9b31a
